      ...
      <div class="col wrapper-box">
        ...
        <div>
          <form class="form form-newaccount" id="passwordForm">
            ...
            <input type="button" v-on:click="newUser()" class="btn btn-default" id="submit" data-loading-text="Cadastrando..." value="Register">
            ...
            <hr>
            <router-link to="/" class="text-link d-block text-right">Already have an account?</router-link>
          </form>
        </div>
      </div>
    </div>
